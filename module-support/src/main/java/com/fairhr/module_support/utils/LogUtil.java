...
public final class LogUtil {
    ...
    public static final String TAG = "_gtjaqh";
    ...
    public static void initLogUtil(boolean on) {
        LogUtil.setToggle(on);
        ...
        LogUtil.setToggleFileLineNumber(true);
        LogUtil.setToggleAuthor(false);
        LogUtil.setTagDefault(TAG);
    }
}
