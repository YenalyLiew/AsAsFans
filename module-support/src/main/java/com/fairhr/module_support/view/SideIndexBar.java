...
public class SideIndexBar extends View{
    ...
    private void init(Context context,AttributeSet attrs) {
        ...
        mTextSize = ta.getDimension(R.styleable.SideIndexBar_sideIndexTextSize,dp2px(11));
        mTextColor = ta.getColor(R.styleable.SideIndexBar_sideIndexTextColor,Color.parseColor("#0089CD"));
        mTextTouchedColor = ta.getColor(R.styleable.SideIndexBar_sideIndexSelectedTextColor,Color.parseColor("#FFFFFF"));
    ...
    protected void onDraw(Canvas canvas) {
        ...
        //  设置画笔颜色
        paint.setColor(getContext().getColor(R.color.font_color_0089CD));
        String index;
        for (int i = 0; i < mIndexItems.size(); i++) {
            ...
            //  绘制实心圆
//            canvas.drawCircle((mWidth - mPaint.measureText(index)), mItemHeight / 2 + (fm.bottom-fm.top) / 2 - fm.bottom + mItemHeight * i + mTopMargin, 10, paint);
