...
//    public static final String USERAGENT_QQ_BROWSER = " MQQBrowser/8.0 ";
    ...
    private void settings(WebView webView) {
        ...
        LogUtil.i(AgentWeb.TAG, "dir:" + dir + "   appcache:" + AgentWebConfig.getCachePath(webView.getContext()));
        ...
        mWebSettings.setUserAgentString(getWebSettings()
                ...
                .concat("GTJAQH/APP/Android/")
                .concat(SystemUtil.getVersionName(ContextUtil.getContext()))
        );
        LogUtil.i(AgentWeb.TAG, "UserAgentString : " + mWebSettings.getUserAgentString());
    }
