...
public final class AgentWeb {
     ...
     * AgentWeb 's TAG
     */
    public static final String TAG = "_web";
    /**
     * Activity
     */
     ...
     * WebChromeClient
     */
    private com.fairhr.module_support.webview.agent.WebChromeClient mWebChromeClient;
    /**
     * WebViewClient
     */
    private com.fairhr.module_support.webview.agent.WebViewClient mWebViewClient;
    /**
     * is show indicator
     */
    ...
    private AgentWeb(AgentBuilder agentBuilder) {
        ...
        if (agentBuilder.mJavaObject != null && !agentBuilder.mJavaObject.isEmpty()) {
            ...
            LogUtil.i(AgentWeb.TAG, "mJavaObject size:" + this.mJavaObjects.size());
        ...
        if (this.mWebCreator.getWebParentLayout() instanceof WebParentLayout) {
            ...
            if (agentBuilder.mNetErrorLayout != 0 && !AgentWebUtils.checkNetwork(mActivity)) {
                mWebParentLayout.setErrorLayoutRes(agentBuilder.mNetErrorLayout, agentBuilder.mReloadId);
                mWebParentLayout.setErrorView(agentBuilder.mNetErrorView);
            } else {
    ...
    private WebViewClient getWebViewClient() {
        LogUtil.i(AgentWeb.TAG, "getDelegate:" + this.mMiddleWrareWebClientBaseHeader);
        ...
        if (header != null) {
            ...
            LogUtil.i(AgentWeb.TAG, "MiddlewareWebClientBase middleware count:" + count);
    ...
    private AgentWeb ready() {
        ...
        LogUtil.i(AgentWeb.TAG, "mJavaObjects:" + mJavaObjects.size());
    ...
    private WebChromeClient getChromeClient() {
        ...
        LogUtil.i(AgentWeb.TAG, "WebChromeClient:" + this.mWebChromeClient);
    ...
    public static class CommonBuilder {
        ...
        public CommonBuilder setWebChromeClient(@Nullable com.fairhr.module_support.webview.agent.WebChromeClient webChromeClient) {
            this.mAgentBuilder.mWebChromeClient = webChromeClient;
            return this;
        }

        public CommonBuilder setWebViewClient(@Nullable com.fairhr.module_support.webview.agent.WebViewClient  webChromeClient) {
        ...
        public CommonBuilder setMainFrameNetErrorView(@NonNull View view) {
            this.mAgentBuilder.mNetErrorView = view;
            return this;
        }

        public CommonBuilder setMainFrameNetErrorView(@LayoutRes int errorLayout, @IdRes int clickViewId) {
            this.mAgentBuilder.mNetErrorLayout = errorLayout;
            this.mAgentBuilder.mReloadId = clickViewId;
            return this;
        }
