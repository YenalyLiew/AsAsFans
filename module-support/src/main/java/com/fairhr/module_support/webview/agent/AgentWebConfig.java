...
import static com.fairhr.module_support.webview.agent.AgentWebUtils.getAgentWebFilePath;
...
public class AgentWebConfig {
     ...
     * AgentWeb 的版本
     */
    public static final String AGENTWEB_VERSION = AGENTWEB_NAME + "/" + SystemUtil.getVersionName(ContextUtil.getContext());
    /**
    ...
    private static ValueCallback<Boolean> getDefaultIgnoreCallback() {
        return new ValueCallback<Boolean>() {
            ...
            public void onReceiveValue(Boolean ignore) {
                LogUtil.i(AgentWeb.TAG, "removeExpiredCookies:" + ignore);
            }
        };
    }
}
