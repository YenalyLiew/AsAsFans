...
import static com.fairhr.module_support.webview.agent.AgentWebConfig.AGENTWEB_FILE_PATH;
import static com.fairhr.module_support.webview.agent.AgentWebConfig.FILE_CACHE_PATH;
...
public class AgentWebUtils {
    ...
    public static String getAgentWebFilePath(Context context) {
        ...
        try {
            ...
            LogUtil.i(AgentWeb.TAG, "create dir exception");
        }
        LogUtil.i(AgentWeb.TAG, "path:" + mFile.getAbsolutePath() + "  path:" + mFile.getPath());
    ...
    static boolean isOverriedMethod(Object currentObject, String methodName, String method, Class... clazzs) {
        LogUtil.i(AgentWeb.TAG, "  methodName:" + methodName + "   method:" + method);
        boolean tag = false;
        ...
        try {
            ...
            LogUtil.i(AgentWeb.TAG, igonre.toString());
        }

        LogUtil.i(AgentWeb.TAG, "isOverriedMethod:" + tag);
        return tag;
    }
...
//			}
    ...
    static void clearAgentWebCache(Context context) {
        try {
            ...
            LogUtil.i(AgentWeb.TAG, throwable.toString());
        }
    }
    ...
    private static String getRealPathBelowVersion(Context context, Uri uri) {
        ...
        LogUtil.i(AgentWeb.TAG, "method -> getRealPathBelowVersion " + uri + "   path:" + uri.getPath() + "    getAuthority:" + uri.getAuthority());
    ...
    static String getFileAbsolutePath(Activity context, Uri fileUri) {
        ...
        LogUtil.i(AgentWeb.TAG, "getAuthority:" + fileUri.getAuthority() + "  getHost:" + fileUri.getHost() + "   getPath:" + fileUri.getPath() + "  getScheme:" + fileUri.getScheme() + "  query:" + fileUri.getQuery());
...
//            ignore.printStackTrace();
    ...
    static boolean showFileChooserCompat(Activity activity,
        ...
        LogUtil.d(AgentWeb.TAG, "showFileChooserCompat");
        try {
            Class<?> clz = Class.forName("com.gtjaqh.support.webview.filechooser.FileChooser");
...
//                LogUtil.i(AgentWeb.TAG, Arrays.toString(clz.getDeclaredMethods()));
            ...
            if (throwable instanceof ClassNotFoundException) {
                LogUtil.i(AgentWeb.TAG, "showFileChooserCompat：Please check whether compile'com.just.agentweb:filechooser:x.x.x' dependency was added.");
            }
            if (valueCallbacks != null) {
                LogUtil.i(AgentWeb.TAG, "showFileChooserCompat：onReceiveValue empty");
                return false;
            }
            if (valueCallback != null) {
...
//        } catch (Exception e) {
//            LogUtil.i(AgentWeb.TAG, e.toString());
//        }
//        return "";
//    }
}
