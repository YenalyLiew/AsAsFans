package com.fairhr.module_support.widget.refresh.footer;
...
import com.fairhr.module_support.widget.refresh.internal.ArrowDrawable;
import com.fairhr.module_support.widget.refresh.internal.InternalClassics;
import com.fairhr.module_support.widget.refresh.internal.ProgressDrawable;
...
public class ClassicsFooter extends InternalClassics<ClassicsFooter> implements RefreshFooter {
    ...
    public ClassicsFooter(Context context, AttributeSet attrs) {
        ...
        View.inflate(context, R.layout.support_classics_footer, this);
